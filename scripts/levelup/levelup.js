...
function LevelingQuest() {
  return {
    ...
    tasks: [{
      ...
      completed: () => property_get("leafletCompleted") || !lib_have(template_string_$item(leveling_templateObject46 || (leveling_templateObject46 = leveling_taggedTemplateLiteral(["strange leaflet"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("leaflet")
    }, {
      name: "Frobozz",
      completed: () => !lib_have(template_string_$item(leveling_templateObject47 || (leveling_templateObject47 = leveling_taggedTemplateLiteral(["Frobozz Real-Estate Company Instant House (TM)"])))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(leveling_templateObject48 || (leveling_templateObject48 = leveling_taggedTemplateLiteral(["Frobozz Real-Estate Company Instant House (TM)"]))))
    }, {
      name: "Bonerdagon Chest",
      completed: () => !lib_have(template_string_$item(leveling_templateObject49 || (leveling_templateObject49 = leveling_taggedTemplateLiteral(["chest of the Bonerdagon"])))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(leveling_templateObject50 || (leveling_templateObject50 = leveling_taggedTemplateLiteral(["chest of the Bonerdagon"]))))
    }, {
      name: "Strange Stalagmite",
      completed: () => !lib_have(template_string_$item(_templateObject51 || (_templateObject51 = leveling_taggedTemplateLiteral(["strange stalagmite"])))) || property_get("_strangeStalagmiteUsed", false),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject52 || (_templateObject52 = leveling_taggedTemplateLiteral(["strange stalagmite"])))),
      choices: {
        1491: () => (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject53 || (_templateObject53 = leveling_taggedTemplateLiteral(["Muscle"]))) ? 1 : (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject54 || (_templateObject54 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? 2 : 3
      }
    }, {
      name: "Bastille Battalion",
      ready: () => lib_have(template_string_$item(_templateObject55 || (_templateObject55 = leveling_taggedTemplateLiteral(["Bastille Battalion control rig"])))),
      ...
      name: "Taffy Effects",
      completed: () => $effects(_templateObject56 || (_templateObject56 = leveling_taggedTemplateLiteral(["Orange Crusher, Purple Reign, Cinnamon Challenger"]))).reduce((a, ef) => a || (0,external_kolmafia_namespaceObject.haveEffect)(ef) >= 50, false),
      do: () => {
        if ((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject57 || (_templateObject57 = leveling_taggedTemplateLiteral(["Muscle"])))) (0,external_kolmafia_namespaceObject.use)(Math.ceil((50 - (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject58 || (_templateObject58 = leveling_taggedTemplateLiteral(["Orange Crusher"]))))) / 10), template_string_$item(_templateObject59 || (_templateObject59 = leveling_taggedTemplateLiteral(["pulled orange taffy"])))); //lasts for 10 turns each
        if ((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject60 || (_templateObject60 = leveling_taggedTemplateLiteral(["Mysticality"])))) (0,external_kolmafia_namespaceObject.use)(Math.ceil((50 - (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject61 || (_templateObject61 = leveling_taggedTemplateLiteral(["Purple Reign"]))))) / 10), template_string_$item(_templateObject62 || (_templateObject62 = leveling_taggedTemplateLiteral(["pulled violet taffy"])))); //lasts for 10 turns each
        if ((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject63 || (_templateObject63 = leveling_taggedTemplateLiteral(["Moxie"])))) (0,external_kolmafia_namespaceObject.use)(Math.ceil((50 - (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject64 || (_templateObject64 = leveling_taggedTemplateLiteral(["Cinnamon Challenger"]))))) / 10), template_string_$item(_templateObject65 || (_templateObject65 = leveling_taggedTemplateLiteral(["pulled red taffy"])))); //lasts for 10 turns each
      },
      ...
      name: "Curiosity",
      completed: () => lib_have($effect(_templateObject66 || (_templateObject66 = leveling_taggedTemplateLiteral(["Curiosity of Br'er Tarrypin"])))) || !lib_have($skill(_templateObject67 || (_templateObject67 = leveling_taggedTemplateLiteral(["Curiosity of Br'er Tarrypin"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject68 || (_templateObject68 = leveling_taggedTemplateLiteral(["Curiosity of Br'er Tarrypin"])))),
      limit: {
        tries: Math.ceil(levelingTurns / 10)
      },
      tracking: "Leveling"
      ...
      name: "Ghost Dog Chow",
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= 8 || template_string_$familiar(_templateObject69 || (_templateObject69 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience > 380,
      prepare: () => (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject70 || (_templateObject70 = leveling_taggedTemplateLiteral(["Grey Goose"])))),
      do: () => (0,external_kolmafia_namespaceObject.use)(Math.floor((400 - template_string_$familiar(_templateObject71 || (_templateObject71 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience) / 20), template_string_$item(_templateObject72 || (_templateObject72 = leveling_taggedTemplateLiteral(["Ghost Dog Chow"])))),
      tracking: "Leveling"
    }, {
      name: "Restore HP",
      ...
      completed: () => !lib_have($skill(_templateObject73 || (_templateObject73 = leveling_taggedTemplateLiteral(["Blood Bubble"])))) || lib_have($effect(_templateObject74 || (_templateObject74 = leveling_taggedTemplateLiteral(["Blood Bubble"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject75 || (_templateObject75 = leveling_taggedTemplateLiteral(["Blood Bubble"])))),
      tracking: "Leveling"
    }, {
      name: "Implement Glitch",
      ready: () => lib_have(template_string_$item(_templateObject76 || (_templateObject76 = leveling_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchItemImplemented"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject77 || (_templateObject77 = leveling_taggedTemplateLiteral(["[glitch season reward name]"]))))
    }, {
      name: "Fight Glitch",
      ready: () => lib_have(template_string_$item(_templateObject78 || (_templateObject78 = leveling_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchMonsterFights") > 0,
      acquire: [].concat(leveling_toConsumableArray(template_string_$items(_templateObject79 || (_templateObject79 = leveling_taggedTemplateLiteral(["gas can, gas balloon, shard of double-ice"]))).map(it => ({
        item: it,
        price: 1000
      }))), leveling_toConsumableArray(lib_have(template_string_$item(_templateObject80 || (_templateObject80 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject81 || (_templateObject81 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      ...
      outfit: () => leveling_objectSpread(leveling_objectSpread({
        familiar: bestFam()
      }, lib_have(template_string_$item(_templateObject82 || (_templateObject82 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) && lib_have($skill(_templateObject83 || (_templateObject83 = leveling_taggedTemplateLiteral(["Torso Awareness"])))) ? {
        shirt: template_string_$item(_templateObject84 || (_templateObject84 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$tryItem$trySki = Macro.tryItem(template_string_$item(_templateObject85 || (_templateObject85 = leveling_taggedTemplateLiteral(["gas balloon"])))).trySkill($skill(_templateObject86 || (_templateObject86 = leveling_taggedTemplateLiteral(["Feel Pride"]))))).tryItem.apply(_Macro$tryItem$trySki, leveling_toConsumableArray(template_string_$items(_templateObject87 || (_templateObject87 = leveling_taggedTemplateLiteral(["shard of double-ice, gas can"]))))).attack().repeat();
      }),
      tracking: "Leveling"
    }, {
      name: "Drunk Pygmies",
      ready: () => (0,external_kolmafia_namespaceObject.canAdventure)($location(_templateObject88 || (_templateObject88 = leveling_taggedTemplateLiteral(["The Hidden Bowling Alley"])))) && !!$effects(_templateObject89 || (_templateObject89 = leveling_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => property_get("_drunkPygmyBanishes") >= 11 && !property_get("crystalBallPredictions").includes($monster(_templateObject90 || (_templateObject90 = leveling_taggedTemplateLiteral(["drunk pygmy"]))).name),
      acquire: [{
        item: template_string_$item(_templateObject91 || (_templateObject91 = leveling_taggedTemplateLiteral(["Bowl of Scorpions"]))),
        price: 1000
      }].concat(leveling_toConsumableArray($monsters(_templateObject92 || (_templateObject92 = leveling_taggedTemplateLiteral(["pygmy orderlies, pygmy bowler"]))).find(mob => !(0,external_kolmafia_namespaceObject.isBanished)(mob)) ? [{
        item: nextUnusedBanishItem(),
        price: 20000
      }] : [])),
      effects: $effects(_templateObject93 || (_templateObject93 = leveling_taggedTemplateLiteral(["Heart of White"]))),
      outfit: () => leveling_objectSpread(leveling_objectSpread(leveling_objectSpread(leveling_objectSpread({
        familiar: template_string_$familiar(_templateObject94 || (_templateObject94 = leveling_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject95 || (_templateObject95 = leveling_taggedTemplateLiteral(["cursed magnifying glass"])))) && template_string_$familiar(_templateObject96 || (_templateObject96 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience < 400 ? {
        offhand: template_string_$item(_templateObject97 || (_templateObject97 = leveling_taggedTemplateLiteral(["cursed magnifying glass"])))
      } : {}), lib_have(template_string_$item(_templateObject98 || (_templateObject98 = leveling_taggedTemplateLiteral(["miniature crystal ball"])))) && property_get("_drunkPygmyBanishes") >= 10 ? {
        famequip: template_string_$item(_templateObject99 || (_templateObject99 = leveling_taggedTemplateLiteral(["miniature crystal ball"])))
      } : {}), lib_have(template_string_$item(_templateObject100 || (_templateObject100 = leveling_taggedTemplateLiteral(["mafia middle finger ring"])))) && (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject101 || (_templateObject101 = leveling_taggedTemplateLiteral(["Muscle"])))) >= 45 && !property_get("_mafiaMiddleFingerRingUsed") ? {
        equip: [template_string_$item(_templateObject102 || (_templateObject102 = leveling_taggedTemplateLiteral(["mafia middle finger ring"])))]
      } : {}), {}, {
      ...
      prepare: () => {
        ...
        if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject103 || (_templateObject103 = leveling_taggedTemplateLiteral(["bowling ball"])))) > 0) (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject104 || (_templateObject104 = leveling_taggedTemplateLiteral(["bowling ball"])))), template_string_$item(_templateObject105 || (_templateObject105 = leveling_taggedTemplateLiteral(["bowling ball"]))));
      },
      do: $location(_templateObject106 || (_templateObject106 = leveling_taggedTemplateLiteral(["The Hidden Bowling Alley"]))),
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject107 || (_templateObject107 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject108 || (_templateObject108 = leveling_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject109 || (_templateObject109 = leveling_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject110 || (_templateObject110 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject111 || (_templateObject111 = leveling_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject112 || (_templateObject112 = leveling_taggedTemplateLiteral(["Convert Matter to Pomade"]))))), $monsters(_templateObject113 || (_templateObject113 = leveling_taggedTemplateLiteral(["void slab, void guy, void spider, drunk pygmy"])))).macro(() => Macro.trySkill($skill(_templateObject114 || (_templateObject114 = leveling_taggedTemplateLiteral(["Show them your ring"])))).externalIf(lib_have($skill(_templateObject115 || (_templateObject115 = leveling_taggedTemplateLiteral(["Snokebomb"])))) && !getBanishedMonsters().get($skill(_templateObject116 || (_templateObject116 = leveling_taggedTemplateLiteral(["Snokebomb"])))), Macro.trySkill($skill(_templateObject117 || (_templateObject117 = leveling_taggedTemplateLiteral(["Snokebomb"]))))).externalIf(lib_have($skill(_templateObject118 || (_templateObject118 = leveling_taggedTemplateLiteral(["Feel Hatred"])))) && !getBanishedMonsters().get($skill(_templateObject119 || (_templateObject119 = leveling_taggedTemplateLiteral(["Feel Hatred"])))), Macro.trySkill($skill(_templateObject120 || (_templateObject120 = leveling_taggedTemplateLiteral(["Feel Hatred"]))))).tryItem(nextUnusedBanishItem()), $monsters(_templateObject121 || (_templateObject121 = leveling_taggedTemplateLiteral(["pygmy bowler, pygmy orderlies, pygmy janitor"])))).macro(Macro.tryItem(template_string_$item(_templateObject122 || (_templateObject122 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun"])))).tryItem(template_string_$item(_templateObject123 || (_templateObject123 = leveling_taggedTemplateLiteral(["spectre scepter"])))).attack().repeat()),
      limit: {
        tries: 15
      },
      tracking: "Leveling"
      ...
      name: "Ball Pit",
      completed: () => !lib_have(template_string_$item(_templateObject124 || (_templateObject124 = leveling_taggedTemplateLiteral(["Clan VIP Lounge key"])))) || property_get("_ballpit"),
      ...
      name: "Telescope Buff",
      completed: () => !(template_string_$item(_templateObject125 || (_templateObject125 = leveling_taggedTemplateLiteral(["Discount Telescope Warehouse gift certificate"]))).name in (0,external_kolmafia_namespaceObject.getCampground)()) || property_get("telescopeLookedHigh"),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("telescope high"),
      tracking: "Leveling"
    }, {
      name: "Fight Seals",
      ready: () => lib_have(template_string_$item(_templateObject126 || (_templateObject126 = leveling_taggedTemplateLiteral(["figurine of a wretched-looking seal"])))) && lib_have(template_string_$item(_templateObject127 || (_templateObject127 = leveling_taggedTemplateLiteral(["seal-blubber candle"])))),
      completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject128 || (_templateObject128 = leveling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 10 || !lib_have(template_string_$item(_templateObject129 || (_templateObject129 = leveling_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) && property_get("_sealsSummoned") >= 5,
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject130 || (_templateObject130 = leveling_taggedTemplateLiteral(["Grey Goose"]))),
      ...
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject131 || (_templateObject131 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject132 || (_templateObject132 = leveling_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject133 || (_templateObject133 = leveling_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject134 || (_templateObject134 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject135 || (_templateObject135 = leveling_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject136 || (_templateObject136 = leveling_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).trySkill($skill(_templateObject137 || (_templateObject137 = leveling_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(_templateObject138 || (_templateObject138 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat()),
      limit: {
        tries: 10
      },
      tracking: "Leveling"
      ...
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject139 || (_templateObject139 = leveling_taggedTemplateLiteral(["Grey Goose"]))),
        modifier: "".concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience, 5 ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience percent, 10 familiar experience")
      }),
      prepare: () => {
      ...
      do: $location(_templateObject140 || (_templateObject140 = leveling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject141 || (_templateObject141 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject142 || (_templateObject142 = leveling_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject143 || (_templateObject143 = leveling_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject144 || (_templateObject144 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject145 || (_templateObject145 = leveling_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject146 || (_templateObject146 = leveling_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).trySkill($skill(_templateObject147 || (_templateObject147 = leveling_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(_templateObject148 || (_templateObject148 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject149 || (_templateObject149 = leveling_taggedTemplateLiteral(["Saucestorm"])))).trySkill($skill(_templateObject150 || (_templateObject150 = leveling_taggedTemplateLiteral(["Saucestorm"])))).attack().repeat()),
      tracking: "Leveling",
      limit: {
        tries: 3
      }
      ...
      name: "Buff Mainstat",
      completed: () => (0,external_kolmafia_namespaceObject.myBuffedstat)((0,external_kolmafia_namespaceObject.myPrimestat)()) >= 10.75 * (0,external_kolmafia_namespaceObject.myBasestat)((0,external_kolmafia_namespaceObject.myPrimestat)()),
      effects: $effects(_templateObject151 || (_templateObject151 = leveling_taggedTemplateLiteral(["Trivia Master"]))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("gain ".concat(11 * (0,external_kolmafia_namespaceObject.myBasestat)((0,external_kolmafia_namespaceObject.myPrimestat)()) + 1, " ").concat((0,external_kolmafia_namespaceObject.myPrimestat)())),
      limit: {
        tries: levelingTurns
      },
      tracking: "Leveling"
      ...
      acquire: () => leveling_toConsumableArray(lib_have($skill(_templateObject152 || (_templateObject152 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject153 || (_templateObject153 = leveling_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]),
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject154 || (_templateObject154 = leveling_taggedTemplateLiteral(["Grey Goose"]))),
      ...
      do: () => {
        var qty = (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject155 || (_templateObject155 = leveling_taggedTemplateLiteral(["eldritch essence"]))));
        if (qty > 0) (0,external_kolmafia_namespaceObject.putCloset)(qty, template_string_$item(_templateObject156 || (_templateObject156 = leveling_taggedTemplateLiteral(["eldritch essence"]))));
        ...
        if (qty > 0) (0,external_kolmafia_namespaceObject.takeCloset)(qty, template_string_$item(_templateObject157 || (_templateObject157 = leveling_taggedTemplateLiteral(["eldritch essence"]))));
      },
      combat: new CombatStrategy().macro(() => Macro.externalIf(lib_have($skill(_templateObject158 || (_templateObject158 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject159 || (_templateObject159 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject160 || (_templateObject160 = leveling_taggedTemplateLiteral(["electronics kit"]))))).externalIf(template_string_$familiar(_templateObject161 || (_templateObject161 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject162 || (_templateObject162 = leveling_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject163 || (_templateObject163 = leveling_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject164 || (_templateObject164 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject165 || (_templateObject165 = leveling_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject166 || (_templateObject166 = leveling_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject167 || (_templateObject167 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject168 || (_templateObject168 = leveling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
      tracking: "Leveling"
    }, {
      name: "God Lobster",
      ready: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel - 1 && !!$effects(_templateObject169 || (_templateObject169 = leveling_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => property_get("_godLobsterFights") >= 3,
      effects: $effects(_templateObject170 || (_templateObject170 = leveling_taggedTemplateLiteral(["Heart of White"]))),
      acquire: () => [].concat(leveling_toConsumableArray(lib_have($skill(_templateObject171 || (_templateObject171 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject172 || (_templateObject172 = leveling_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), leveling_toConsumableArray(lib_have(template_string_$familiar(_templateObject173 || (_templateObject173 = leveling_taggedTemplateLiteral(["God Lobster"])))) ? [] : [{
        item: template_string_$item(_templateObject174 || (_templateObject174 = leveling_taggedTemplateLiteral(["Dish of Clarified Butter"]))),
        price: property_get("valueOfAdventure") / 2
      }]), leveling_toConsumableArray(lib_have(template_string_$item(_templateObject175 || (_templateObject175 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject176 || (_templateObject176 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => leveling_objectSpread(leveling_objectSpread(leveling_objectSpread({}, lib_have(template_string_$familiar(_templateObject177 || (_templateObject177 = leveling_taggedTemplateLiteral(["God Lobster"])))) ? {
        familiar: template_string_$familiar(_templateObject178 || (_templateObject178 = leveling_taggedTemplateLiteral(["God Lobster"])))
      } : {}), lib_have(template_string_$item(_templateObject179 || (_templateObject179 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
        shirt: template_string_$item(_templateObject180 || (_templateObject180 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
      ...
      do: () => {
        if (lib_have(template_string_$familiar(_templateObject181 || (_templateObject181 = leveling_taggedTemplateLiteral(["God Lobster"]))))) (0,external_kolmafia_namespaceObject.visitUrl)("main.php?fightgodlobster=1");else (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject182 || (_templateObject182 = leveling_taggedTemplateLiteral(["Dish of Clarified Butter"]))));
        (0,external_kolmafia_namespaceObject.runCombat)();
      ...
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject183 || (_templateObject183 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject184 || (_templateObject184 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject185 || (_templateObject185 = leveling_taggedTemplateLiteral(["electronics kit"]))))).tryItem(template_string_$item(_templateObject186 || (_templateObject186 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject187 || (_templateObject187 = leveling_taggedTemplateLiteral(["Sing Along"])))).trySkill($skill(_templateObject188 || (_templateObject188 = leveling_taggedTemplateLiteral(["Feel Pride"])))).attack().repeat()),
      limit: {
        tries: 3
      },
      tracking: "Leveling"
      ...
      ready: () => property_get("neverendingPartyAlways") && !!$effects(_templateObject189 || (_templateObject189 = leveling_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => property_get("_neverendingPartyFreeTurns") >= 10 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject190 || (_templateObject190 = leveling_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      effects: $effects(_templateObject191 || (_templateObject191 = leveling_taggedTemplateLiteral(["Heart of White"]))),
      acquire: () => [].concat(leveling_toConsumableArray(lib_have($skill(_templateObject192 || (_templateObject192 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject193 || (_templateObject193 = leveling_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), leveling_toConsumableArray(lib_have(template_string_$item(_templateObject194 || (_templateObject194 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject195 || (_templateObject195 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => leveling_objectSpread(leveling_objectSpread({
        familiar: template_string_$familiar(_templateObject196 || (_templateObject196 = leveling_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject197 || (_templateObject197 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
      ...
      do: $location(_templateObject199 || (_templateObject199 = leveling_taggedTemplateLiteral(["The Neverending Party"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      choices: {
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$step$externalI = Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject200 || (_templateObject200 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject201 || (_templateObject201 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject202 || (_templateObject202 = leveling_taggedTemplateLiteral(["electronics kit"]))))).trySkill($skill(_templateObject203 || (_templateObject203 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).externalIf(template_string_$familiar(_templateObject204 || (_templateObject204 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject205 || (_templateObject205 = leveling_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject206 || (_templateObject206 = leveling_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject207 || (_templateObject207 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject208 || (_templateObject208 = leveling_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject209 || (_templateObject209 = leveling_taggedTemplateLiteral(["Convert Matter to Pomade"])))))).tryItem.apply(_Macro$step$externalI, leveling_toConsumableArray(template_string_$items(_templateObject210 || (_templateObject210 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun, HOA citation pad"]))))).trySkill($skill(_templateObject211 || (_templateObject211 = leveling_taggedTemplateLiteral(["Sing Along"])))).externalIf((0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel - 2, Macro.trySkill($skill(_templateObject212 || (_templateObject212 = leveling_taggedTemplateLiteral(["Feel Pride"]))))).attack().repeat();
      }),
      limit: {
        tries: 13
      },
      ...
      ready: () => !!$effects(_templateObject213 || (_templateObject213 = leveling_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => args.targetlevel === -1 && freeKillsRemaining() === 0,
      effects: [].concat(leveling_toConsumableArray($effects(_templateObject214 || (_templateObject214 = leveling_taggedTemplateLiteral(["Heart of White"])))), leveling_toConsumableArray(finLoc === $location(_templateObject215 || (_templateObject215 = leveling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))) ? $effects(_templateObject216 || (_templateObject216 = leveling_taggedTemplateLiteral(["Expert Vacationer"]))) : []), leveling_toConsumableArray(finLoc === $location(_templateObject217 || (_templateObject217 = leveling_taggedTemplateLiteral(["Hamburglaris Shield Generator"]))) ? $effects(_templateObject218 || (_templateObject218 = leveling_taggedTemplateLiteral(["Transpondent"]))) : [])),
      acquire: () => [].concat(leveling_toConsumableArray(lib_have($skill(_templateObject219 || (_templateObject219 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject220 || (_templateObject220 = leveling_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), leveling_toConsumableArray(lib_have(template_string_$item(_templateObject221 || (_templateObject221 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject222 || (_templateObject222 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject223 || (_templateObject223 = leveling_taggedTemplateLiteral(["Grey Goose"]))),
        equip: [].concat(leveling_toConsumableArray(lib_have(template_string_$item(_templateObject224 || (_templateObject224 = leveling_taggedTemplateLiteral(["The Jokester's gun"])))) && (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject225 || (_templateObject225 = leveling_taggedTemplateLiteral(["Moxie"])))) >= 50 && !property_get("_firedJokestersGun") ? template_string_$items(_templateObject226 || (_templateObject226 = leveling_taggedTemplateLiteral(["The Jokester's gun"]))) : lib_have(template_string_$item(_templateObject227 || (_templateObject227 = leveling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && property_get("_chestXRayUsed") < 3 ? template_string_$items(_templateObject228 || (_templateObject228 = leveling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))) : []), leveling_toConsumableArray(lib_have(template_string_$item(_templateObject229 || (_templateObject229 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? template_string_$items(_templateObject230 || (_templateObject230 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))) : [])),
        modifier: "effective, 0.125 ".concat((0,external_kolmafia_namespaceObject.myPrimestat)(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience, 5 ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience percent, 10 familiar experience, ").concat(noML())
      }),
      prepare: () => {
        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
      ...
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject231 || (_templateObject231 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject232 || (_templateObject232 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject233 || (_templateObject233 = leveling_taggedTemplateLiteral(["electronics kit"]))))).trySkill($skill(_templateObject234 || (_templateObject234 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).externalIf(template_string_$familiar(_templateObject235 || (_templateObject235 = leveling_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject236 || (_templateObject236 = leveling_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject237 || (_templateObject237 = leveling_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject238 || (_templateObject238 = leveling_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject239 || (_templateObject239 = leveling_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject240 || (_templateObject240 = leveling_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject241 || (_templateObject241 = leveling_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject242 || (_templateObject242 = leveling_taggedTemplateLiteral(["Sing Along"])))).externalIf((0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel - 2, Macro.trySkill($skill(_templateObject243 || (_templateObject243 = leveling_taggedTemplateLiteral(["Feel Pride"]))))).trySkill($skill(_templateObject244 || (_templateObject244 = leveling_taggedTemplateLiteral(["Fire the Jokester's Gun"])))).trySkill($skill(_templateObject245 || (_templateObject245 = leveling_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill($skill(_templateObject246 || (_templateObject246 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill($skill(_templateObject247 || (_templateObject247 = leveling_taggedTemplateLiteral(["Shattering Punch"])))).externalIf(property_get("_usedReplicaBatoomerang") < 3, Macro.tryItem(template_string_$item(_templateObject248 || (_templateObject248 = leveling_taggedTemplateLiteral(["replica bat-oomerang"]))))).attack().repeat()),
      limit: {
